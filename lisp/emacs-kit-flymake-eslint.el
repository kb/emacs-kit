;;; emacs-kit-flymake-eslint.el --- Flymake backend for ESLint  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-kit-flymake-eslint
  :if emacs-kit-enable-flymake-eslint
  :ensure nil
  :no-require t
  :defer t
  :hook
...
(provide 'emacs-kit-flymake-eslint)
;;; emacs-kit-flymake-eslint.el ends here
