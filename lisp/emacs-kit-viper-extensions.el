;;; emacs-kit-viper-extensions.el --- Vim-like keybindings and text objects for Viper  -*- lexical-binding: t; -*-
;;
...
(use-package emacs-kit-viper-extensions
  :ensure nil
  :no-require t
  :defer t
  :after viper
...
A compound word includes letters, numbers, `-`, and `_`."
  ...
  (define-key viper-vi-global-user-map (kbd "SPC m p") 'emacs-kit-formatter/format-current-file-manual)
  ...
  ;; Gutter
  (define-key viper-vi-global-user-map (kbd "] c") 'emacs-kit/goto-next-hunk)
  (define-key viper-vi-global-user-map (kbd "[ c") 'emacs-kit/goto-previous-hunk))

(provide 'emacs-kit-viper-extensions)
;;; emacs-kit-viper-extensions.el ends here
