;;; emacs-kit-yt.el --- YouTube search and playback with yt-dlp and mpv  -*- lexical-binding: t; -*-
;;
...
(provide 'emacs-kit-yt)
;;; emacs-kit-yt.el ends here
